...
def test_all_registered_commands_have_integration_tests() -> None:
...
def test_at_least_one_skill_is_registered() -> None:
    ...
    assert command_count > 0, "No commands found in registry"
